...
AdvancedCodeAnalysis analyze(const uint8_t* code, size_t code_size) noexcept
{
    ...
    // request to resize to "max_instrs_size"
...
//    auto code_pos = code;
    ...
    while (code_pos < code_end)
    {
        ...
        // printf("%d-%d. Code analyzed: 0x%x - %s\n", code_pos, count++, opcode, instr::traits[opcode].name);
        ...
        case ANY_LARGE_PUSH:
        {
            ...
            // printf("Large push analyzed, size = %d ...\n", push_size);
...
//            instr.arg.number = code_pos - code - 1;
    ...
    // TODO: Check for errors and emit exceptions

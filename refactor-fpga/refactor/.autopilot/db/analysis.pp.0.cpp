...
#pragma pack(pop)
# 10 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 2 3
...
extern "C" {
# 26 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
  struct _iobuf {
    char *_ptr;
    int _cnt;
    char *_base;
...
# 80 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 81 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 2 3
...
# 377 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 552 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
  __attribute__((__format__ (ms_printf, 3, 0))) __attribute__ ((__nonnull__ (3)))
...
# 741 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 784 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 814 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 841 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 2 3
# 850 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 942 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
int __attribute__((__cdecl__)) __mingw_str_wide_utf8 (const wchar_t * const wptr, char **mbptr, size_t * buflen);
# 956 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
int __attribute__((__cdecl__)) __mingw_str_utf8_wide (const char *const mbptr, wchar_t ** wptr, size_t * buflen);
# 965 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 572 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdlib.h" 3
...
# 1039 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\wchar.h" 3
}
...
# 15 "D:/Xillin/Vitis_HLS/2020.2/tps/mingw/6.2.0/win64.o/nt\\x86_64-w64-mingw32\\include\\locale.h" 3
#pragma pack(push,_CRT_PACKING)
...
struct block_analysis
{
    ...
    const block_info close() const noexcept {

     return block_info(gas_cost, stack_req, stack_max_growth);
...
AdvancedCodeAnalysis analyze(const uint8_t* code, size_t code_size) noexcept
{
    constexpr auto op_tbl = default_op_table;
    ...
    analysis.instrs.emplace_back(OPX_BEGINBLOCK);
    auto block = block_analysis{0};




    const auto code_end = code_size;
    auto code_pos = 0;
    auto count = 0;
    VITIS_LOOP_67_1: while (code_pos < code_end)
    {

        const auto opcode = code[code_pos++];
        ...
        if (opcode == OP_JUMPDEST)
        {
         ...
         analysis.jumpdest_offsets.emplace_back(static_cast<int32_t>(code_pos - 1));
            analysis.jumpdest_targets.emplace_back(
                static_cast<int32_t>(analysis.instrs.size() - 1));
        }
        else
            analysis.instrs.emplace_back(opcode);
        ...
        case OP_PUSH1: case OP_PUSH2: case OP_PUSH3: case OP_PUSH4: case OP_PUSH5: case OP_PUSH6: case OP_PUSH7: case OP_PUSH8:
        {
            ...
            VITIS_LOOP_114_2: while (code_pos < push_end)
            {
                value |= uint64_t{code[code_pos++]} << insert_bit_pos;
                insert_bit_pos -= 8;
            }
...
# 148 "analysis.cpp"
            VITIS_LOOP_148_3: while (code_pos < push_end && code_pos < code_end)
                *insert_pos-- = code[code_pos++];
        ...
        case OP_PC:
         ...
         instr.arg.number = code_pos - 1;
            break;
        }


        if (is_terminator || (code_pos != code_end && code[code_pos] == OP_JUMPDEST))
        {

         block_info blk_close = block.close();
            analysis.instrs[block.begin_block_index].arg.block = blk_close;
    ...
    analysis.instrs.emplace_back(OP_STOP);
# 199 "analysis.cpp"
    return analysis;
}

...
//			throw hex_error{hex_errc::invalid_hex_digit};
	...
	inline void from_hex(string_view hex, OutputIt result)
	{
...
//			throw hex_error{hex_errc::incomplete_hex_byte_pair};
	...
	std::error_code validate_hex(string_view hex) noexcept
	{
...
// cannot use 'try' with exceptions disabled: evmc/hex.cpp:99:3
//		try
//		{
//			from_hex(hex, noop_output_iterator{});
//			return {};
...
//			return e.code();
//		}
		// by default, returns no error
		return {};
	}

	bytes from_hex(string_view hex)
	{
		bytes bs;

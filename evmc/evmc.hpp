...
public:
	...
	// change function variable to functions
	evmc_bytes32 get_storage(struct evmc_host_context* /*context*/, const evmc_address* /*address*/, const evmc_bytes32* /*key*/){
		evmc_bytes32 result;
		return result;
	};
	...
	evmc_uint256be get_code_hash(struct evmc_host_context* /*context*/, const evmc_address* /*address*/){
		evmc_uint256be result;
		return result;
	};
	...
	void selfdestruct(struct evmc_host_context* /*context*/, const evmc_address* /*address*/, const evmc_address* /*beneficiary*/){

	};

	evmc_result call(struct evmc_host_context* /*context*/, const struct evmc_message* /*msg*/){
		evmc_result result;
		return result;
	};

	evmc_tx_context get_tx_context(struct evmc_host_context* /*context*/){
	...
	enum evmc_access_status access_account (struct evmc_host_context* /*context*/, const evmc_address* /*address*/){
...
public:
    ...
    bool account_exists(const address& /*address*/) const noexcept
    {
        // return host.account_exists(context, &address);
    	return true;
    }

    bytes32 get_storage(const address& /*address*/, const bytes32& /*key*/) const noexcept
    {
    ...
    uint256be get_balance(const address& /*address*/) const noexcept
    {
    	uint256be result;
    	return result;
    ...
    size_t get_code_size(const address& /*address*/) const noexcept
    {
        // return host->get_code_size(context, &address);
    	return 8192;
    }

    bytes32 get_code_hash(const address& /*address*/) const noexcept
    {
    	bytes32 result;
		return result;
    ...
    void selfdestruct(const address& /*addr*/, const address& /*beneficiary*/) noexcept
    {
    ...
    {
    	result r{EVMC_SUCCESS, 0, NULL, 0};
    	return r;
...
//            tx_context = host->get_tx_context(context);
    ...
    bytes32 get_block_hash(int64_t /*number*/) const noexcept
    {
    ...
    evmc_access_status access_account(const address& /*address*/) noexcept
    {
        // return host->access_account(context, &address);
    	return EVMC_ACCESS_WARM;
    }

    evmc_access_status access_storage(const address& /*address*/, const bytes32& /*key*/) noexcept
    {
    	return EVMC_ACCESS_WARM;
